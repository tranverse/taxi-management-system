...
const BookingDetail = ({ customer }) => {
  ...
  return (
    ...
    <>
      <Breadcrumb
        routes={[
          { path: "/booking/detail", name: "Thông tin chuyến xe", icon: "booking" },
        ]}
      />          <div className='mx-30 my-10'>
        <div className={`grid grid-cols-1 lg:grid-cols-[1.8fr_2fr] mb-20`}>
        ...
        <div>
          <Heading message="Đánh giá của bạn" className="mt-5 mb-5"></Heading>
